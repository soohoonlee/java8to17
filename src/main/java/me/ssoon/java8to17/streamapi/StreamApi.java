package me.ssoon.java8to17.streamapi;
...
public class StreamApi {
	...
	public static void main(String[] args) {
		...
		List<List<OnlineClass>> soohoonEvents = new ArrayList<>();
		soohoonEvents.add(springClasses);
		soohoonEvents.add(javaClasses);


		System.out.println("==================================================================");
		System.out.println("두 수업 목록에 들어 있는 모든 수업 아이디 출력");
		soohoonEvents.stream()
		...
		List<String> spring = springClasses.stream().map(OnlineClass::getTitle).filter(title -> title.contains("spring")).toList();
